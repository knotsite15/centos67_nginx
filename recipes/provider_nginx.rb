      ...
      class NginxServiceSysVinit < Chef::Provider::NginxServiceBase
        ...
        action :start do
          ...
          service "#{nginx_instance_name} :start" do
            ...
            provider Chef::Provider::Service::Init::Debian if node['platform_family'] == 'centos'
        ...
        action :stop do
          service "#{nginx_instance_name} :stop" do
            ...
            provider Chef::Provider::Service::Init::Redhat if node['platform_family'] == 'centos'
            supports status: true, restart: true
            action [:stop, :disable]
          end
        end
        ...
        action :restart do
          ...
          service "#{res_name} :restart #{nginx_instance_name}" do
            service_name nginx_instance_name
            supports status: true, restart: true
            provider Chef::Provider::Service::Init::CentOS if node['platform_family'] == 'centos'
